...
TEST_EPISODE = 300                      # Num of validation episode
...
encoder_saved_model = "/data/ssongad/codes/ctc2/models/CTC_HAA/0.8755555555555554/encoder.pkl"     # Path of saved encoder model
rn_saved_model = "/data/ssongad/codes/ctc2/models/CTC_HAA/0.8755555555555554/rn.pkl"               # Path of saved relation net model
tcn_saved_model = "/data/ssongad/codes/ctc2/models/CTC_HAA/0.8755555555555554/tcn.pkl"             # Path of saved tcn model
rn0_saved_model = "/data/ssongad/codes/ctc2/models/CTC_HAA/0.8755555555555554/rn0.pkl"             # Path of saved rn0 model
...
def main():
    ...
    with torch.no_grad():
        ...
        for test_episode in range(TEST_EPISODE):
            ...
            sample_dataloader = dataset.get_data_loader(haaDataset,num_per_class=SAMPLE_NUM)
            batch_dataloader = dataset.get_data_loader(haaDataset,num_per_class=QUERY_NUM,shuffle=True)
            try:
